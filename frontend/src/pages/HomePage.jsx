          ...
          <form onSubmit={onSubmit} className="space-y-4 text-left">
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <input
                ...
                name="name"
                required
                className="w-full rounded-xl border border-slate-200 bg-slate-50 p-4 text-sm outline-none focus:border-blue-500 focus:bg-white transition"
            ...
            <textarea
              name="message"
              required
              className="w-full rounded-xl border border-slate-200 bg-slate-50 p-4 text-sm outline-none focus:border-blue-500 focus:bg-white transition h-32 resize-none"
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full rounded-xl bg-slate-900 py-4 font-bold text-white shadow-lg transition hover:bg-blue-600"
            >
              Send Message
            </motion.button>
          </form>
